package cc.doctor.search.client.index.schema.typehandlers;

import cc.doctor.search.common.exceptions.schema.TypeHandlerNotFoundException;
import cc.doctor.search.client.index.schema.reader.SchemaReader;
