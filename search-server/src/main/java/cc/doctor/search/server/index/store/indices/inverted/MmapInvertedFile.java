...
import static cc.doctor.search.server.index.store.mm.ScrollFile.AutoIncrementScrollFileNameStrategy.autoIncrementScrollFileNameStrategy;
...
public class MmapInvertedFile extends InvertedFile {
    ...
    public static final int flushTableNum = Settings.settings.getInt(GlobalConfig.FLUSH_INVERTED_TABLE_NUM);
    ...
    public MmapInvertedFile(IndexerMediator indexerMediator) {
        ...
        scrollFile = new MmapScrollFile(indexerMediator.getShardRoot() + "/" + GlobalConfig.INVERTED_FILE_PATH_NAME,
                Settings.settings.getInt(GlobalConfig.INVERTED_FILE_SIZE_NAME), autoIncrementScrollFileNameStrategy);
