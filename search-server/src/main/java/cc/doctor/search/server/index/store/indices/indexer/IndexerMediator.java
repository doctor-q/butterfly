package cc.doctor.search.server.index.store.indices.indexer;
...
import cc.doctor.search.server.index.store.indices.format.DateFormat;
import cc.doctor.search.server.index.store.indices.format.Format;
import cc.doctor.search.server.index.store.indices.format.FormatProber;
import cc.doctor.search.server.index.store.indices.indexer.datastruct.TrieTree;
import cc.doctor.search.server.index.store.indices.inverted.DictFile;
import cc.doctor.search.server.index.store.indices.inverted.InvertedFile;
import cc.doctor.search.server.index.store.indices.inverted.MmapInvertedFile;
...
import static cc.doctor.search.server.index.store.indices.format.Format.*;
