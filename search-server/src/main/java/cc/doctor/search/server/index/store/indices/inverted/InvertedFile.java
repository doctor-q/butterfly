...
import cc.doctor.search.server.index.cache.Cache;
import cc.doctor.search.server.index.cache.LocalCache;
...
public abstract class InvertedFile {
    ...
    public static final int CACHE_INVERTED_TABLE_SIZE = Settings.settings.getInt(GlobalConfig.CACHE_INVERTED_TABLE_SIZE);
